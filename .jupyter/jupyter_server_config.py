...
#  Default: ''
c.ServerApp.root_dir = '/Users/jakub/Documents/Programowanie/Python/nyc_tlc_trip_data'
...
## Transport encryption policy for manager-side provisioning of CurveZMQ server
#  keys for kernels. 'disabled' (default) does not provision Curve credentials,
#  'auto' provisions when the kernelspec declares support, and 'required'
#  enforces provisioning and fails startup if transport encryption cannot be
#  applied.
#  Choices: any of ['disabled', 'auto', 'required'] (case-insensitive)
#  Default: 'disabled'
# c.KernelManager.transport_encryption = 'disabled'
...
## Transport encryption policy for manager-provisioned CurveZMQ keys for all
#  managed kernels. 'disabled' (default) does not provision Curve credentials,
#  'auto' provisions when the kernelspec declares support, and 'required'
#  enforces provisioning and fails kernel startup if encryption cannot be
#  applied.
#  Choices: any of ['disabled', 'auto', 'required'] (case-insensitive)
#  Default: 'disabled'
# c.MappingKernelManager.transport_encryption = 'disabled'
...
#  enforces provisioning and fails kernel startup if encryption cannot be
#  applied.
#  See also: MappingKernelManager.transport_encryption
# c.AsyncMappingKernelManager.transport_encryption = 'disabled'
...
#  Choices: any of ['blake2s', 'shake_128', 'sha512_224', 'sm3', 'md5-sha1', 'sha3_384', 'shake_256', 'sha3_256', 'sha384', 'ripemd160', 'sha512_256', 'sha224', 'sha3_512', 'sha1', 'sha3_224', 'sha512', 'sha256', 'md5', 'blake2b']
#  Default: 'sha256'
...
#  Choices: any of ['blake2s', 'sha3_384', 'sha3_256', 'sha224', 'sha512', 'sha3_512', 'sha384', 'sha256', 'sha3_224', 'sha1', 'md5', 'blake2b']
#  Default: 'sha256'
...
#  applied.
#  See also: MappingKernelManager.transport_encryption
# c.GatewayMappingKernelManager.transport_encryption = 'disabled'
